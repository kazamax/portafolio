            ...
            <section id="service-page" class="pages service-page">
                <div class="container">
                    <div class="row">
                                ...
                                <div class="row service-parts">
                                    <div class="col-md-6">
                                        <div class="block wow fadeInUp animated" data-wow-duration="400ms" data-wow-delay="600ms">
                                            <i class="ion-easel"></i>
                                            <h4>Sitios responsivos</h4>
                                            <p>Lo veo como un requisito indispensable para que pueda ser visualizado desde cualquier dispositivo sin importar las dimensiones de pantalla.</p>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="block wow fadeInUp animated" data-wow-duration="400ms" data-wow-delay="850ms">
                                            <i class="ion-ios-locked"></i>
                                            <h4>La seguridad</h4>
                                            <p>Para mantener los datos de los usuarios, lo mas encapsulados y seguros posibles de los ataques mas usuales que suelen usar los hackers.</p>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="block wow fadeInUp animated" data-wow-duration="400ms" data-wow-delay="1.1s">
                                            ...
                                            <h4>Branding</h4>
                                            <p>Como toque extra podria trabajar la parte de el branding, el cual llevando a cabo una serie de estrategias te ayuda, a construir tu propia marca.</p>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="block wow fadeInUp animated" data-wow-duration="400ms" data-wow-delay="1.4s">
                                            <i class="ion-android-checkbox"></i>
                                            <h4>Software escalable</h4>
                                            <p>Necesario en caso de que el cliente en un futuro, necesite hacer algun cambio,  agregar un nuevo modulo a su pagina web, entre otras cosas.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="block wow fadeInRight" data-wow-delay="1.7s" data-wow-duration="800ms">
                                <div class="embed-responsive embed-responsive-4by3">
                                  <iframe width="640" height="360" src="https://www.youtube.com/embed/fjfMbAw5mWY" frameborder="0" allowfullscreen></iframe>
                              </div>
                          </div>
                      </div>
                  </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="img-wrapper">
                        ...
                        <div class="overlay">
                            <div class="buttons">
                                <a rel="gallery" class="fancybox" href="images/portfolio/portafolio-webkaz-roberto-figuera.png" alt="demo portafolio desarrollo web-kaz">Demo</a>
